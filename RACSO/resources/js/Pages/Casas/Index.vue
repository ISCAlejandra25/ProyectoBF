<script setup>
    ...
    function destroy(id) {
        if (confirm("Esta seguro de eliminar el registro de Casa")) {
            form.delete(route('casas.destroy', id));
        }
    }
    </script>
                           ...
                           <div class="mb-2">
                            ...
                            >
                                ...
                                >
                                    ...
                                    <tbody>
                                        <tr v-for="casa in casas" :key="casa.id" class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
